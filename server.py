...
# Configure the HTTP listen address/port and SSH target server address/port below.
...
# Address / port that the HTTP server listens on
# Leave as localhost if running on the same server as the reverse proxy server.
HOST_NAME= 'localhost'
PORT_NUMBER = 9000

# Address and port for the target SSH server. Modify these as needed.
